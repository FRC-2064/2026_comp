...
public class LEDS extends SubsystemBase {
    ...
    private static final RGBWColor kViolet = RGBWColor.fromHSV(
        Degrees.of(270),
        0.9,
        0.8
    );
    private static final RGBWColor kRed = RGBWColor.fromHex(
        "D9000000"
    ).orElseThrow();
    ...
    private final CANdle m_candle = new CANdle(1, new CANBus());
