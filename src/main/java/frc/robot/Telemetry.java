...
public class Telemetry {
    private static final double kTelemetryPeriodSeconds = 0.02;
    private static final boolean kPublishModuleMechanisms = RobotBase.isSimulation();
    ...
    public void telemeterize(SwerveDriveState state) {
        if (state.Timestamp - lastTelemetryTimestamp < kTelemetryPeriodSeconds) {
            return;
        }
        lastTelemetryTimestamp = state.Timestamp;
