...
public class FieldConstants {
    ...
    public static class LinesHorizontal {
        ...
        public static final double rightBumpEnd =
            rightBumpStart - RightBump.width;
    ...
    public static class Tower {
        ...
        public static final double innerOpeningWidth = Units.inchesToMeters(
            32.250
        );
    ...
    public static class Depot {
        ...
        public static final double distanceFromCenterY = Units.inchesToMeters(
            75.93
        );
                    ...
                    if (layout == null) {
                        try {
                            Path p = Path.of(
                                ...
                                "apriltags",
                                FieldConstants.fieldType.getJsonFolder(),
                                name + ".json"
                            );
