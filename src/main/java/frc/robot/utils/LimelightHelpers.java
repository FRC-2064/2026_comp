...
public class LimelightHelpers {
    ...
    public static RawFiducial[] getRawFiducials(String limelightName) {
        ...
        for (int i = 0; i < numFiducials; i++) {
            ...
            double distToCamera = extractArrayEntry(
                rawFiducialArray,
                baseIndex + 4
            );
            double distToRobot = extractArrayEntry(
                rawFiducialArray,
                baseIndex + 5
            );
            double ambiguity = extractArrayEntry(
                rawFiducialArray,
                baseIndex + 6
            );
    ...
    public static RawDetection[] getRawDetections(String limelightName) {
        ...
        for (int i = 0; i < numDetections; i++) {
            ...
            double corner0_X = extractArrayEntry(
                rawDetectionArray,
                baseIndex + 4
            );
            double corner0_Y = extractArrayEntry(
                rawDetectionArray,
                baseIndex + 5
            );
            double corner1_X = extractArrayEntry(
                rawDetectionArray,
                baseIndex + 6
            );
            double corner1_Y = extractArrayEntry(
                rawDetectionArray,
                baseIndex + 7
            );
            double corner2_X = extractArrayEntry(
                rawDetectionArray,
                baseIndex + 8
            );
            double corner2_Y = extractArrayEntry(
                rawDetectionArray,
                baseIndex + 9
            );
            double corner3_X = extractArrayEntry(
                rawDetectionArray,
                baseIndex + 10
            );
            double corner3_Y = extractArrayEntry(
                rawDetectionArray,
                baseIndex + 11
            );
    ...
    public static void printPoseEstimate(PoseEstimate pose) {
        ...
        System.out.printf(
            "Average Tag Distance: %.2f meters%n",
            pose.avgTagDist
        );
        System.out.printf(
            "Average Tag Area: %.2f%% of image%n",
            pose.avgTagArea
        );
     ...
     * @return
     */
    public static PoseEstimate getBotPoseEstimate_wpiBlue(
        String limelightName
    ) {
     ...
     */
    public static void setKeystone(
        String limelightName,
        double horizontal,
        double vertical
    ) {
     ...
     */
    public static void triggerRewindCapture(
        String limelightName,
        double durationSeconds
    ) {
        double[] currentArray = getLimelightNTDoubleArray(
            limelightName,
            "capture_rewind"
        );
